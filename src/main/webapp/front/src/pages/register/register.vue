<template>
	...
	<div class="container" :style='{"minHeight":"100vh","alignItems":"center","backgroundImage":"url(http://codegen.caihongy.cn/20221024/23b37078fa41495b866fda764fd3ea28.png)","display":"flex","width":"100%","backgroundSize":"100% 100%","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
		<el-form class='rgs-form' v-if="pageFlag=='register'" :style='{"padding":"20px","borderRadius":"10px","left":"565px","background":"#fff","width":"750px","position":"absolute","height":"auto"}' ref="registerForm" :model="registerForm" :rules="rules">
			...
			<div v-if="true" :style='{"width":"100%","margin":"30px 0 20px 0","lineHeight":"44px","fontSize":"36px","color":"#000","textAlign":"center"}'>智能家政保洁预约系统注册</p></div>
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='yonghu'" prop="yonghushouji">
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='jiazhengrenyuan'" prop="jiazhengzhanghao">
				<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}'>家政账号：</div>
				<el-input v-model="registerForm.jiazhengzhanghao"  placeholder="请输入家政账号" />
			</el-form-item>
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='jiazhengrenyuan'" prop="mima">
				<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}'>密码：</div>
				<el-input v-model="registerForm.mima" type="password" placeholder="请输入密码" />
			</el-form-item>
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='jiazhengrenyuan'" prop="mima">
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='jiazhengrenyuan'" prop="jiazhengxingming">
				<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}'>家政姓名：</div>
				<el-input v-model="registerForm.jiazhengxingming"  placeholder="请输入家政姓名" />
			</el-form-item>
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='jiazhengrenyuan'" prop="xingbie">
				<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}'>性别：</div>
                <el-select v-model="registerForm.xingbie" placeholder="请选择性别" >
                  <el-option
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='jiazhengrenyuan'" prop="nianling">
				<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}'>年龄：</div>
				<el-input v-model="registerForm.nianling"  placeholder="请输入年龄" />
			</el-form-item>
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='jiazhengrenyuan'" prop="lianxidianhua">
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='jiazhengrenyuan'" prop="tupian">
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='jiazhengrenyuan'" prop="gongzuojingyan">
				<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}'>工作经验：</div>
				<el-input v-model="registerForm.gongzuojingyan"  placeholder="请输入工作经验" />
			</el-form-item>
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='jiazhengrenyuan'" prop="minzu">
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='jiazhengrenyuan'" prop="zuigaoxueli">
				<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}'>最高学历：</div>
				<el-input v-model="registerForm.zuigaoxueli"  placeholder="请输入最高学历" />
			</el-form-item>
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            var url=this.tableName+"/register";
               ...
               if(`jiazhengrenyuan` == this.tableName && this.registerForm.mima!=this.registerForm.mima2) {
                this.$message.error(`两次密码输入不一致`);
                return
               }
