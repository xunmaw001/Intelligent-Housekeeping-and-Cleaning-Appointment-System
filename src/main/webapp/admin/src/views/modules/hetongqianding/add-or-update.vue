<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="预约编号" prop="yuyuebianhao">
					<el-input v-model="ruleForm.yuyuebianhao" placeholder="预约编号" clearable  :readonly="ro.yuyuebianhao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' v-else class="input" label="预约编号" prop="yuyuebianhao">
				...
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' v-else class="input" label="合同编号" prop="hetongbianhao">
					<el-input v-model="ruleForm.hetongbianhao" placeholder="合同编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info'&& !ro.qiandingwenjian" label="签订文件" prop="qiandingwenjian">
					<file-upload
						tip="点击上传签订文件"
						action="file/upload"
						:limit="1"
						:multiple="true"
						:fileUrls="ruleForm.qiandingwenjian?ruleForm.qiandingwenjian:''"
						@change="qiandingwenjianUploadChange"
					></file-upload>
				</el-form-item>  
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' v-else-if="ruleForm.qiandingwenjian" label="签订文件" prop="qiandingwenjian">
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 25px","margin":"0 20px 0 0","outline":"none","color":"#000","borderRadius":"30px","background":"#D5EBC4","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="text" size="small" @click="download($base.url+ruleForm.qiandingwenjian)">下载</el-button>
				</el-form-item>
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' v-else-if="!ruleForm.qiandingwenjian" label="签订文件" prop="qiandingwenjian">
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 25px","margin":"0 20px 0 0","outline":"none","color":"#000","borderRadius":"30px","background":"#D5EBC4","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="text" size="small">无</el-button>
				</el-form-item>
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="签订时间" prop="qiandingshijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.qiandingshijian" label="签订时间" prop="qiandingshijian">
...
export default {
	data() {
		...
		return {
			...
			rules: {
				...
				qiandingwenjian: [
					{ required: true, message: '签订文件不能为空', trigger: 'blur' },
				],
				qiandingshijian: [
				],
			}
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='qiandingwenjian'){
							this.ruleForm.qiandingwenjian = obj[o];
							this.ro.qiandingwenjian = true;
							continue;
						}
	...
	if(this.ruleForm.qiandingwenjian!=null) {
		this.ruleForm.qiandingwenjian = this.ruleForm.qiandingwenjian.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    qiandingwenjianUploadChange(fileUrls) {
	    this.ruleForm.qiandingwenjian = fileUrls;
    },
  }
};
</script>
